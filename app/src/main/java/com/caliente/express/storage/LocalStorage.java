package com.caliente.express.storage;
...
public class LocalStorage {
    ...
    public static void setMenu(MenuResponse value) {
        menu = value;
    }
    ...
    {
        sharedPreferences = context.getSharedPreferences("CalienteExpressStorage", Activity.MODE_PRIVATE);
